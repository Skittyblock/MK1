...
void notifcb(CFNotificationCenterRef center, void *observer, CFStringRef name, const void*object, CFDictionaryRef userInfo){
...
-(void)loadView{
    ...
    if(center){
        CFNotificationCenterAddObserver(center, NULL, notifcb, CFSTR("com.castyte.mk1app.updateconsole"), NULL, CFNotificationSuspensionBehaviorDeliverImmediately);
    }
}
